...
#' @param thresh A finite positive scalar selection threshold, where \eqn{\widehat{\lambda}_k(\tau) > } `thresh` means the \eqn{k}-th variable is selected, and not selected otherwise.
