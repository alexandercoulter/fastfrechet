...
#'                                    nudge = 0.001)
#'                                  
#' # Plot FRiSO results in new plot:
...
#' 
#' # Note that with this sample size, we have sufficient information to correctly
#' # identify the first 4 variables as significantly affecting our QFs.
