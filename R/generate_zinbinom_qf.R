...
#'
#' @description
#' This function generates random zero-inflated negative binomial (zinbinom) quantile functions, as functions of covariates X1, X2, X3, and X4. Quantile functions are generated from `X` parameters as in Experiment B in \insertCite{coulter_fast_2024}{fastfrechet}, and are evaluated on a common, equally spaced `m`-grid in (0, 1). Options include number of samples (covariate vectors, and response quantile functions), number of total covariates (at least 4; generated iid from N(0, 1)), grid density `m`, and baseline zinbinom parameters.
#' 
#' @param n 
#' @param p 
#' @param m 
